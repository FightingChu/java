...
public class ChinesToSpell {

    public static void main(String[] args) {
        System.out.println("获取汉字首字母："+getFirstSpell("贵阳银行"));
        System.out.println("汉字转化为拼音："+getPingYin("贵阳-银行.png"));
        System.out.println("汉字转化为拼音："+getFullSpell("贵阳银行"));
